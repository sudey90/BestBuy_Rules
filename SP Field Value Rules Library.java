...
<Rule created="1662746628145" id="0ada675983231b498183236c10310089" language="beanshell" modified="1719894049274" name="SP Field Value Rules Library">
  <Source>
    ...
    private static Object getRuleResult(SailPointContext context, Identity identity, Object ruleObject,String defaultValue,String op,Bundle role, String appName) {
        Object val = null;
        Object[] params;
        ...
        mapParam.put("reqrole",role);
        mapParam.put("appName",appName);
            ...
            else
            {
                ...
                if (defaultValue == null || defaultValue.equals("")) {
                    ...
                    params = new Object[] {context,identity,op,defaultValue,role,appName};
                } else {
